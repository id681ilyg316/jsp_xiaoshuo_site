...
<script type="text/javascript" src="/xiaoshuo_site/javascript/comment/editor/third-party/jquery.min.js"></script>
<script type="text/javascript" src="/xiaoshuo_site/javascript/comment/editor/third-party/template.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/xiaoshuo_site/javascript/comment/editor/umeditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/xiaoshuo_site/javascript/comment/editor/editor_api.js"></script>
<script type="text/javascript" src="/xiaoshuo_site/javascript/comment/editor/lang/zh-cn/zh-cn.js"></script>
...
<body>
	...
	<div class= "title">
	<p><a href="/xiaoshuo_site/jsp/main.jsp">返回主页</a></p>
	   <div class="by">
	   <a href="/xiaoshuo_site/jsp/userdetail.jsp?uid=<%=post.getUser_id() %>" class="icon"><img width="48px" height="48px" src="/xiaoshuo_site/images/<%=u.getUser_icon() %>"></a>
	   <p>标题:&nbsp;&nbsp;&nbsp;<b title="<%=post.getTitle()%>"><%=post.getTitle()%></b></p>
	   <p>by:&nbsp;&nbsp;&nbsp;<a href="/xiaoshuo_site/jsp/userdetail.jsp?uid=<%=post.getUser_id() %>"><%=u.getNickname()%></a></p>
	   <p> 发表时间:&nbsp;&nbsp;<%=post.getPost_time() %>&nbsp;&nbsp;<span class="comment_counter">评论数：<%=cs.size() %></span></p>
	   <p><span><a id="del" style="display:none;" href="javascript:deletePost('<%=post.getPost_id() %>')">删除小说</a></span></p>
	   </div>
	</div>
	<script type="text/javascript">
     ...
     function deletePost(id){
    	 ...
    	 $.ajax({
    		 url : "/xiaoshuo_site/deletePost?id="+"<%=post.getPost_id() %>",
    		 type : 'get',
    		 dataType : 'text',
...
%>
	...
	<script type="text/javascript" src="/xiaoshuo_site/javascript/comment.js">
     </script>
	<div id="footer">
